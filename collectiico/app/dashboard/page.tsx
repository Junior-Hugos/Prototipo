...
export default function DashboardHomePage() {
  ...
  return (
    // AJUSTE: padding reduzido (p-6) e animação suave
    <div className="p-6 max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500">
      
      {/* Cabeçalho */}
      {/* AJUSTE: padding reduzido (p-6 ao invés de p-8) */}
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
          {/* AJUSTE: Fonte reduzida de text-3xl para text-xl (Médio e Elegante) */}
      ...
      <div>
        ...
        {recentColeta ? (
           <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 border-l-4 border-green-500 flex flex-col md:flex-row justify-between items-center gap-6 hover:shadow-md transition-shadow">
              ...
              <button 
                ...
                className="px-5 py-2.5 bg-gray-50 text-gray-700 hover:text-green-700 hover:bg-green-50 font-semibold rounded-lg transition-all text-xs border border-gray-200 cursor-pointer"
              >
