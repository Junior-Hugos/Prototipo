...
import { useAuth } from "../context/AuthContext";
import Link from "next/link";
>>>>>>> a4e29c4 (Criação do middleware para o dashboard)
    ...
    <div className="min-h-screen flex items-center justify-center">
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-card">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-text-secondary">Senha</label>
                  <input
                      type="password"
            ...
            <p className="text-sm text-text-secondary text-center mt-6">
              Não tem cadastro? <Link href="/cadastro" className="text-primary font-medium hover:underline">Clique aqui</Link>.
            </p>
        </div>
=======
